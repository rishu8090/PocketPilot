package com.example.pocketpilot.feature.stats
...
import com.example.pocketpilot.viewModel.StatsViewModel
import com.example.pocketpilot.viewModel.StatsViewModelFactory
...
import com.example.pocketpilot.feature.home.TransactionList
...
fun LineChart(entries: List<Entry>) {
    ...
    AndroidView(factory = {
        ...
        if(entries.isEmpty()){
            Log.w("ChartDebug","Chart is Empty")
            return@AndroidView
        }
